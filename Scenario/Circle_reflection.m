...
theta = linspace(0, (19/20)*2*pi, 20);  % Angles for a regular heptagon
radius = 20;                   % Radius of the heptagon
...
y_c0 = 0;  % y-coordinate of the center
...
Line40 = animatedline('Color', [0.8 0.8 0], 'Marker', 'o');
Line41 = animatedline('Color', [0.4 0 0.4]); % Dark Purple
Line42 = animatedline('Color', [0.4 0 0.4], 'Marker', 'o');
...
addpoints(Line40, xd(N-18, 1), xd(N-18, 2));
addpoints(Line41, x1_values(N-19, 1:i), x2_values(N-19, 1:i));
addpoints(Line42, xd(N-19, 1), xd(N-19, 2));

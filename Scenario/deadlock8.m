...
theta = linspace(0, (7/8)*2*pi, 8);  % Angles for a regular heptagon
radius = 10;                   % Radius of the heptagon

delta1 = 0.3 * rand(1, 8);
delta2 = 0.3 * rand(1, 8);
x1 = [radius * cos(theta)]'+delta1';
x2 = [radius * sin(theta)]'+delta2';
...
Line13 = animatedline('Color', 'g');
Line14 = animatedline('Color', 'g', 'Marker', 'o');
Line15 = animatedline('Color', 'r');
Line16 = animatedline('Color', 'r', 'Marker', 'o');
Line17 = animatedline('Color', 'c');
Line18 = animatedline('Color', 'c', 'Marker', 'o');
